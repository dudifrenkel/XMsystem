...
import com.XMsystem.Service.ExamineeService;
...
public class ExamineeController {
    ...
    public String addNewExaminee (@ModelAttribute("examinee") Examinee examinee){
        // TODO: 01/08/2018 format check for inputs
//        if(res.hasErrors()){
//            System.out.println(res);
//        }
//        model.addAttribute("command",new Examinee());
//        model.addAttribute("message", examineeService.addExaminee(examinee).getFirstName()+" successfully saved");
